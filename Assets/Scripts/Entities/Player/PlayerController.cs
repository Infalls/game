...
{
    [SerializeField] private float speedX = 5f; // ск-ть по оси Х
    ...
    public float _speedMultiplier = 50f; // множитель скорости
    ...
    {
        _rb.velocity = new Vector2(_horizontal * speedX * Time.fixedDeltaTime * _speedMultiplier, _rb.velocity.y);
